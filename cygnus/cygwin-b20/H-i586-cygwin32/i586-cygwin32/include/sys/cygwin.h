...
extern void cygwin_win32_to_posix_path_list (const char *, char *);
extern int cygwin_win32_to_posix_path_list_buf_size (const char *);
extern void cygwin_posix_to_win32_path_list (const char *, char *);
...
extern int cygwin_attach_handle_to_fd (char *, int, HANDLE, int, int);
#endif
