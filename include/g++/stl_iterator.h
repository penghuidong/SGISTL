...
struct input_iterator_tag {};             //read only,only ++
struct output_iterator_tag {};            //write only, only ++
struct forward_iterator_tag :             //read and write, can ++ or --
	public input_iterator_tag {};
struct bidirectional_iterator_tag :       //双向移动，可++和--
	public forward_iterator_tag {};
struct random_access_iterator_tag :       //功能最全
...
/*STL 提供的用于继承的iterator，自定义迭代器需继承自它才能符合STL规范*/
...
struct iterator_traits<T*> {
  typedef random_access_iterator_tag iterator_category; //原生指针作为迭代器是random_access_iterator
  typedef T                          value_type;
